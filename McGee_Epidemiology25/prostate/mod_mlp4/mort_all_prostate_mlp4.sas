...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Incorporating a 4-year lag for treatment and covariates, but not diagnosed diseases that are included in the xcond variable
...
data bytimes;
    set gcomp.bytimes_prostate_mlp4;
...
proc freq data =  gcomp.bytimes_prostate_mlp4;
