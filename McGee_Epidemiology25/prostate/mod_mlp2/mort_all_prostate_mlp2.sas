...
Purpose of Program: Run parametric g-formula for the the effect of a recommendation-based 
                    ...
                    Incorporating a 2-year lag for treatment and covariates, but not diagnosed diseases that are included in the xcond variable
...
data bytimes;
    set gcomp.bytimes_prostate_mlp2;
...
proc freq data =  gcomp.bytimes_prostate_mlp2;
