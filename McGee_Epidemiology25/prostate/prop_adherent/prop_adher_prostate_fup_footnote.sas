...
Purpose of Program: Run parametric g-formula for the the effect of a recommendation-based 
                    ...
                    average % adhering over follow-up assuming everyone would have reverted 
                    back to their natural behavior had the intervention been discontinued 
                    right before the start of the prior follow-up period
...
fixedcov = baseage baseage_spl1
    ...
    cov3  = lcal,   cov3otype   = 3,  cov3ptype  = skpcat,   cov3knots = 7.49554194  7.82404601, cov3skip = 1 3 5 7 9,
    cov4  = totalc,    cov4otype  = 4,  cov4ptype  = skpspl,   cov4knots = 0.1  0.5  3, cov4skip = 1 3 5 7 9,
    cov5  = sodajuice, cov5otype  = 4, cov5ptype  = skpqdc,   cov5skip = 1 3 5 7 9,
    cov6  = junk,   cov6otype   = 3,  cov6ptype  = skpqdc,   cov6skip = 1 3 5 7 9,
    cov7  = totproc, cov7otype  = 4,  cov7ptype  = skpspl,   cov7knots = 0.1  1   6, cov7skip = 1 3 5 7 9,
    cov8  = totfv,  cov8otype   = 3,  cov8ptype  = skpspl,   cov8knots = 2.4  5   9, cov8skip = 1 3 5 7 9,
    cov9  = totred, cov9otype   = 3,   cov9ptype  = skpspl,   cov9knots = 1  3   7, cov9skip = 1 3 5 7 9,
    cov10  = totgrn, cov10otype   = 3,  cov10ptype  = skpspl,   cov10knots = 0.5  1.5   3, cov10skip = 1 3 5 7 9,
