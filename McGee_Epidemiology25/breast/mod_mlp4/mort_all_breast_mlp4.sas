...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Incorporating a 2-year lag for treatment and covariates, but not diagnosed diseases that are included in the xcond variable or diagnosed diabetes (i.e., confirmed diagnoses)
...
proc freq data =  gcomp.bytimes_breast_mlp4;
