...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 ...
				 additionally adjusting for current use of TAF  
...
SENSITIVITY ANALYSIS: Additionally adjusting for current use of TAF 
/**********************************************************************************************************************************/
...
outcomeCov = female age age1 tsinceart tsinceart1 
			 ...
			 diabetes_new has_ckd missing_ckd has_taf,
outcomeClass = ,   
