...
***********************************************************************************************************************************; 
data naive_pp; set 'path to data'; run;
...
proc sort data=naive_pp;
by id month2;
run;

/**********************************************************************************************************************************/
/* PER-PROTOCOL ANALYSIS IN ART-NAIVE INDIVIDUALS */
/**********************************************************************************************************************************/
...
model_switchd = female age age1 
				...
				aids cd4_v_ln cd4_v_l1 rna_v_ln rna_v_l1 
				hcv_cat has_hbv missing_hbv bmi_elev bmi_missing chol_high chol_missing 
				has_hypertension missing_hypertension smoking exsmoking missing_smoking
				abc_bl diabetes_new has_ckd missing_ckd , 
cov_switchd = female age age1 
			  aquitaine_cohort athena_cohort bmc_cohort ccc_cohort coris_cohort icona_cohort 
			  primo_cohort sac_cohort shcs_cohort vacs_cohort
			  hetero_mode idu_mode other_no_mode 
			  aids cd4_v_ln cd4_v_l1 rna_v_ln rna_v_l1 
