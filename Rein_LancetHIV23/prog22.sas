...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 using an ITT analysis and adjusting for baseline confounding and using a relaxed definition of eligibility:
...
elig_switch_new = 0 ;
if last_visit_cd4 <= 3 and last_visit_rna <= 3 and cancer_v ne 1 and art_naive_l1 = 0 and everinsti_l1 = 0 and rna_v <= 50 then elig_switch_new = 1;
run;
...
/**********************************************************************************************************************************/
/* ITT ANALYSIS IN ART-EXPERIENCED INDIVIDUALS: SENSITIVITY ANALYSIS: USING RELAXED DEFINITION OF ELIGIBILITY
/**********************************************************************************************************************************/
