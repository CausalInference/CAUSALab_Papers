...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 ...
				 restricting follow-up to years from 2016 onwards
...
if current_d_2 ge mdy(01,01,2016) then keep_fu=1;
else keep_fu=0;
run;
data insti; set insti;
where keep_fu=1;
...
SENSITIVITY ANALYSIS: Restricting follow-up to years from 2016 onwards
/**********************************************************************************************************************************/
