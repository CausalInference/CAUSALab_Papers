...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 using an ITT analysis and adjusting for time, cohort, sex and age
...
/**********************************************************************************************************************************/
/* ITT ANALYSIS IN ART-EXPERIENCED INDIVIDUALS: MODEL ADJUSTED FOR TIME, COHORT, AGE AND SEX ONLY */
/**********************************************************************************************************************************/
...
outcomeCov = female age age1 aquitaine_cohort athena_cohort bmc_cohort ccc_cohort 
			 coris_cohort icona_cohort primo_cohort sac_cohort seropri_cohort shcs_cohort vacs_cohort,
outcomeClass = ,   
outcomeCov_var = female age age1 aquitaine_cohort athena_cohort bmc_cohort ccc_cohort 
			 	 coris_cohort icona_cohort primo_cohort sac_cohort seropri_cohort shcs_cohort vacs_cohort,
final_analysis = 1,  
calculate_var = 0,
final_method=0, 
