...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 ...
				 excluding cohorts that were included in the previous analysis by RESPOND [Athena, Icona and SHCS]
...
where cohort ne "shcs" and cohort ne "athena" and cohort ne "icona";
run;
...
SENSITIVITY ANALYSIS: excluding cohorts that were included in the previous analysis by RESPOND
/**********************************************************************************************************************************/
...
outcomeCov = female age age1 tsinceart tsinceart1 
			 minority_ethnic unknown_ethnic aquitaine_cohort bmc_cohort ccc_cohort 
			 coris_cohort primo_cohort sac_cohort seropri_cohort vacs_cohort 
