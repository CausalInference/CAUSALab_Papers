...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-naive people with HIV 
				 ...
				 restricting Initiators to dolutegravir- or bictegravir-based regimens  
...
/* variable indicating whether someone is on DTG or BIC */
data insti; set insti;
if index(drugs_v, "DTG") then has_dtg=1;
else has_dtg=0;
if index(drugs_v, "BIC") then has_bic=1;
else has_bic=0;
run;
data insti; set insti;
if elig_init=1 and has_insti=1 and has_dtg=0 and has_bic=0 then elig_init=0;
run;
...
SENSITIVITY ANALYSIS: Restricting Initiators to dolutegravir- or bictegravir-based regimens 
/**********************************************************************************************************************************/
