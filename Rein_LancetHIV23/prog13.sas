...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-naive people with HIV 
				 using an ITT analysis, adjusting for baseline confounding and restricting initiators to top three most used INSTI regimens
...
/* Variable indicating whether initiators have taken one of the three most used regimens: 'common_drug_naive' */
data insti; set insti;
if (drugs_v="/ / 3TC ABC / DTG / /" or drugs_v="/ / FTC TAF / BIC / /" or drugs_v="/ / FTC TDF / DTG / /") and elig_init=1 then common_drug_naive=1;
else common_drug_naive=0;
run;
data insti; set insti;
if elig_init=1 and has_insti=1 and common_drug_naive ne 1 then elig_init=0;
run;
...
/**********************************************************************************************************************************/
/* ITT ANALYSIS IN ART-NAIVE INDIVIDUALS: SENSITIVITY ANALYSIS: Restricting initiators to top three most used INSTI regimens 
/**********************************************************************************************************************************/
