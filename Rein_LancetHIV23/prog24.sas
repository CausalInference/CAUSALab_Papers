...
File...........: Estimation of cumulative incidence of cardiovascular events in ART-experienced people with HIV 
				 ...
				 only including cohorts with information on all types of CVD events
...
data insti; set 'path to data'; run;
 /* exclude cohorts without information of all types of CVD events */
data insti; set insti;
where cohort ne "bmc" and cohort ne "ccc" and cohort ne "vacs";
run;
...
/**********************************************************************************************************************************/
/* ITT ANALYSIS IN ART-EXPERIENCED INDIVIDUALS: 
SENSITIVITY ANALYSIS: Only including cohorts with information on all types of CVD events [all cohorts except BMC, CCC and VACS]
/**********************************************************************************************************************************/
...
outcomeCov = female age age1 tsinceart tsinceart1 
			 minority_ethnic unknown_ethnic aquitaine_cohort athena_cohort 
			 coris_cohort icona_cohort primo_cohort sac_cohort seropri_cohort shcs_cohort  
