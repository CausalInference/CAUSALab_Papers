################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3/gformula_age_80_lethal_fatal.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-28
# Please note: this R code used the same model settings as the one for the primary analysis.
# We excluded people aged >= 80 at baseline and changed the xcond_int() function whose 
...
saveRDS(fit, "gformula_sens_age_80_lethal_fatal.rds")
