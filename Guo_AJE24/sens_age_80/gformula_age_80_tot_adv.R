################################################################
# CAUSALAB 
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_age_80/gformula_age_80_tot_adv.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-28
# Please note: this R code used the same model settings as the one for the primary analysis.
# We excluded people aged >= 80 at baseline and changed the xcond_int() function whose details can be seen in 
# "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_age80/gformula_setting_restriction.R"

# 1) Purpose: this R program used the parametric g-formula to estimate 26-yr
# risks on the WCRF 2018 recommendations for the sensitivity analysis that included
# individuals aged <80 years at baseline 
...
#        ""/n/hpnh/Users/fyguo/R_proj/code_Review/sens_age_80/gformula_setting_restriction.R""
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_age_80")
...
# here we only included people whose age was less than 80 at baseline
dta <- dta[age_base<80,]

source("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_age_80/gformula_setting_restriction.R")
ncores <- 50
...
saveRDS(fit, "gformula_sens_age_80_tot_adv.rds")
