################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_no_adjusting_energy/gformula_no_adjusting_energy_lethal_fatal.R
# Programer: Fuyu Guo
...
Sys.time()
saveRDS(fit, "gformula_no_adjusting_energy_lethal_fatal.rds")
