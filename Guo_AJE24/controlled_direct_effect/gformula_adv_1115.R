################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/main_analysis_C_D_Y/gformula_adv_1115.R
# Programer: Fuyu Guo
...
# 2) Outcome: advanced prostate cancer (secondary analysis for the controlled direct effect) 
# 3) input files:
#     - SAS dataset: "/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/competing_data_structure_C_D_Y/wcrf_fg_1115_adv.sas7bdat"
#     - R codes:
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/controlled_direct_effect")
...
fit <- gformula(obs_data =dta,
                ...
                # we treat competing-events as censoring to 
                # assess the controlled effect
                compevent_cens = TRUE,
...
saveRDS(fit, "/n/hpnh/Users/fyguo/R_proj/code_Review/controlled_direct_effect/gformula_adv_1115.rds")
