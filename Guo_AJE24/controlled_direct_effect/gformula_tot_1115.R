...
# 2) Outcome: total prostate cancer (secondary analysis for the controlled direct effect) 
# 3) input files:
...
saveRDS(fit, "/n/hpnh/Users/fyguo/R_proj/code_Review/controlled_direct_effect/gformula_tot_1115.rds")
