################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/main_analysis_C_D_Y/gformula_lethal_1115.R
# Programer: Fuyu Guo
...
# 2) Outcome: lethal prostate cancer (secondary analysis for the controlled direct effect) 
# 3) input files:
...
saveRDS(fit, "/n/hpnh/Users/fyguo/R_proj/code_Review/controlled_direct_effect/gformula_lethal_1115.rds")
