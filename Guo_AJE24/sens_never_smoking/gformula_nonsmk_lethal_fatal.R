################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_never_smoking/gformula_nonsmk_lethal_fatal.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-28
# Please note: this R code used the same model settings as the one for the primary analysis.
# We only included people who had never smoked at baseline (1990).
...
# restricted to never-smokers at baseline 
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_never_smoking")
...
# restricted to people whose smkhx = 0
dta <- dta %>% filter(smkhx ==0)
...
saveRDS(fit, "gformula_nonsmk_lethal_fatal.rds")
