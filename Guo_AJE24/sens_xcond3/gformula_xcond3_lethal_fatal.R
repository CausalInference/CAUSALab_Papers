################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3/gformula_xcond3_lethal_fatal.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-27
# Please note: this R code used the same model settings as the one for the primary analysis.
# We only changed the xcond_int() function whose details can be seen in 
# "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3/gformula_setting_restriction.R"
# Briefly, we excused individuals from following the physical activity intervention once
# they had xcond2 = 1 in the primary whereas while we excused them upon their xcond3 = 1 in the
# this sensitivity analysis

# 1) Purpose: this R program used the parametric g-formula to estimate 26-yr
# risks on the WCRF 2018 recommendations
# 2) Outcome: lethak prostate cancer; fatal prostate cancer
# 3) input files:
#     - SAS dataset: 
#         "/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/expend_xcond3/wcrf_fg_1115_lethal.sas7bdat"
#         "/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/expend_xcond3/wcrf_fg_1115_fatal.sas7bdat"
#     - R codes:
...
#        ""/n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3Y/gformula_setting_restriction.R""
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3")
...
dta <- read_sas("/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/expend_xcond3/wcrf_fg_1115_lethal.sas7bdat")
...
source("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_xcond3/gformula_setting_restriction.R")
ncores <- 50
...
dta <- read_sas("/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/expend_xcond3/wcrf_fg_1115_fatal.sas7bdat")
...
saveRDS(fit, "gformula_xcond3_lethal_fatal.rds")
