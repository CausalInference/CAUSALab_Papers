################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_alter_sequence/gformula_alter_sequence_tot_adv.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-30

# Please note: we changed the model settings for altering the order of time-varying treatment covariates 
# See "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_alter_sequence/gformula_setting_restriction.R"
...
#        ""/n/hpnh/Users/fyguo/R_proj/code_Review/sens_alter_sequence/gformula_setting_restriction.R""
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_alter_sequence")
...
source("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_alter_sequence/gformula_setting_restriction.R")
ncores <- 50
...
Sys.time()
saveRDS(fit, "gformula_alter_sequence_tot_adv.rds")
