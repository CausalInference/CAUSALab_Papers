...
# that altered the order of time-varying treatment covariates 
...
covnames <- c(
  ...
  "dia", "hbp", "chl",
  "cal", "bmi", "xcond2", 
  "totalc", "sodajuice", "totproc",
  "totred", "junk", "totgrn", "totfv",
  "act")
covtypes <- c(
  'custom',
  "absorbing", "absorbing", "absorbing",  
  "normal","normal", "absorbing",
  "zero-inflated normal", "zero-inflated normal", "zero-inflated normal", 
