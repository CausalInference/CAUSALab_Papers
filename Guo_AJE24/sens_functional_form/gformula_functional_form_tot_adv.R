################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_functional_form/gformula_functional_form_tot_adv.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-30

# Please note: we changed the model settings for the g-formula to use splines for 
# age and pre-baseline BMI. See "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_functional_form/gformula_setting_restriction.R"
...
# specified different functional forms for the covariates 
...
#        "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_functional_form/gformula_setting_restriction.R"
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_functional_form")
...
# read in total data
dta <- read_sas("/n/hpnh/Users/fyguo/data/generate_data_1115/competing_data_structure_C_D_Y/wcrf_fg_1115_tot.sas7bdat")
...
source("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_functional_form/gformula_setting_restriction.R")
ncores <- 50
...
saveRDS(fit, "gformula_fun_splines_tot_adv.rds")
