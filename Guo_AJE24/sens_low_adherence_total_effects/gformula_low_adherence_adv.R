################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_low_adherence_total_effects/gformula_low_adherence_adv.R
# Programer: Fuyu Guo
...
# 2) Outcome: advanced prostate cancer (primary analysis for total effects comparing the risks under the 
...
saveRDS(fit, "gformula_adv_low_adherence.rds")
Sys.time()
