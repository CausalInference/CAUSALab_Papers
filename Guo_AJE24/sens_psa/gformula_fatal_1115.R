################################################################
# CAUSALAB
# /n/hpnh/Users/fyguo/R_proj/code_Review/sens_psa/gformula_fatal.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-29
# Please note: this R code changed the model settings. Compared to the models
# in the primary analysis, this R code further adjusted for prostate specific 
# antigen testing in the 
# "/n/hpnh/Users/fyguo/R_proj/code_Review/sens_psa/gformula_setting_restriction.R"

# 1) Purpose: this R program conducted the sensitivity analysis that additionally adjusted
# for PSA testing
# 2) Outcome: fatal prostate cancer
# 3) input files:
#     - SAS dataset: 
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_psa")
...
# Model settings
source("/n/hpnh/Users/fyguo/R_proj/code_Review/sens_psa/gformula_setting_restriction.R")
...
saveRDS(fit, "gformula_fatal_1115.rds")
