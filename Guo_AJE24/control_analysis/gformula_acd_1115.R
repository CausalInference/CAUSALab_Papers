################################################################
# CAUSALAB 
# /n/hpnh/Users/fyguo/R_proj/code_Review/control_analysis/gformula_acd_1115.R
# Programer: Fuyu Guo
# Last updated: 2023-Jun-30
# Please note this program aimed for the negative outcome control. We used
# the same model settings as in the primary except for changing the outcome and 
# competing event settings. 
# See "/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/control_data/wcrf_fg_acd_1115.sas"


# 1) Purpose: this R program used the parametric g-formula to estimate 26-yr
# risks of accidental and injury-related deaths under interventions based on the WCRF 2018 recommendations 
# 2) Outcome: accidental and injury-related deaths
# 3) input files:
#     - SAS dataset: "/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/control_data/wcrf_fg_1115_acd.sas7bdat"
#     - R codes:
...
library(gfoRmula)
library(parallel)
setwd("/n/hpnh/Users/fyguo/R_proj/code_Review/control_analysis")
...
####################################################################
# read in data
dta <- read_sas("/n/hpnh/Users/fyguo/data/SAS_code_review_21Jun2023/control_data/wcrf_fg_1115_acd.sas7bdat")
...
fit <- gformula(obs_data =dta,
                ...
                # here we choose compevent_cens = T, because we want to 
                # estimate the controlled direct effect on negative outcome controls.
                compevent_cens = TRUE,
...
saveRDS(fit, "gformula_acd_1115.rds")
